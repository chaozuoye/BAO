...
namespace General
{
	public static class WavUtility
	{
		...
		{
			string file;
			return _FromAudioClip(audioClip, out file, false);
		}

		public static byte[] _FromAudioClip(AudioClip audioClip, out string filepath, bool saveAsFile = true, string dirname = "recordings")
		{
